        ...
        <div className="bg-surface-900 text-white rounded-xl p-8 sm:p-12 mb-12 relative overflow-hidden">
          <div className="relative z-10 max-w-3xl">
            <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-brand-500 text-white rounded-full text-xs font-bold uppercase tracking-wider mb-4">
              UK Additive Manufacturing Leaders
            </span>
            <h1 className="font-display text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight mb-4">
              Empowering British Industry with Production-Grade 3D Solutions
            </h1>
            <p className="text-xs sm:text-sm text-surface-300 leading-relaxed max-w-2xl">
              FORGE 3D is a premier UK distributor and turnkey solutions provider of industrial 3D printing equipment, large-format LFAM systems, 3D scanners, and advanced polymer materials.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center mb-16">
          <div className="lg:col-span-7 space-y-4">
            ...
            <p className="text-xs sm:text-sm text-surface-600 leading-relaxed">
              Founded by mechanical and materials engineers, FORGE 3D was created to solve a real industry challenge: too many engineering firms were buying machines without proper UK-based technical back-up, material training, or warranty security.
            </p>
            <p className="text-xs sm:text-sm text-surface-600 leading-relaxed">
              Today, from our West Midlands Technology Demonstration Centre, we deliver complete 360° additive manufacturing integrations. We ensure every machine we supply is fully commissioned, integrated with local exhaust ventilation, and calibrated for your exact production materials.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 pt-4">
              <div className="p-4 bg-white border border-surface-200 rounded-xl shadow-xs">
                ...
                <span className="text-[11px] text-surface-500 font-medium">UK Factory Installations</span>
              </div>
              <div className="p-4 bg-white border border-surface-200 rounded-xl shadow-xs">
              ...
              <div className="p-4 bg-white border border-surface-200 rounded-xl shadow-xs">
                ...
                <span className="text-[11px] text-surface-500 font-medium">UK Engineer Dispatch</span>
              </div>
            </div>
          </div>
            ...
            <div className="relative rounded-xl overflow-hidden shadow-lg border border-surface-200">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-surface-900/80 via-transparent to-transparent flex items-end p-6">
                <div className="text-white">
                  <span className="text-[10px] font-bold uppercase tracking-wider text-brand-400">West Midlands Demonstration Facility</span>
