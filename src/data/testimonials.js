export const reviewsSummary = {
  ...
  trustpilotLogoUrl: 'https://cdn.trustpilot.net/brand-assets/4.1.0/logo-white.svg',
  breakdown: {
    5: 92,
    4: 7,
    3: 1,
...
export const testimonials = [
  {
    ...
    role: "Head of Advanced Prototyping",
    company: "Apex Aerostructures Ltd",
    location: "Bristol, UK",
    rating: 5,
    date: "14 May 2024",
    verified: true,
  ...
  {
    id: 2,
    author: "Markus Henderson",
    role: "Lead Tooling Engineer",
    company: "Vanguard Motorsport Engineering",
  ...
  },
  {
    ...
    role: "Director of Quality & Metrology",
    company: "Precision Castings Group",
  ...
  },
  {
    ...
    company: "Caledonia Heavy Equipment",
    location: "Glasgow, UK",
    rating: 5,
    date: "22 March 2024",
    verified: true,
    product: "Raise3D Pro3 Plus & Drywise",
    category: "Heavy Industry",
    title: "Zero print failures since adding the Drywise inline nylon conditioning",
    quote: "Pairing the Raise3D Pro3 Plus with Drywise for carbon-nylon jig production has completely eliminated porosity. The delivery was swift, communication was crystal clear, and when we needed spare hotends, they arrived next morning.",
    avatar: null
  },
  {
    id: 5,
    author: "Elena Rostova",
    role: "Biomedical Additive Specialist",
    company: "Orthopaedic Medical Solutions",
    location: "Oxford, UK",
    rating: 5,
  ...
  },
  {
    ...
    company: "AeroDynamics Consultancy Ltd",
